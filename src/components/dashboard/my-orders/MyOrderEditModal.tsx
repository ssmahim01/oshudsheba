  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-full sm:max-w-160 gap-0 p-0 overflow-hidden rounded-2xl border-gray-200/80 dark:border-gray-800">
        ...
        {/* Status notice */}
        <div className="flex items-center gap-2 border-b border-[#007BFF] bg-[#007BFF]/60 px-6 py-2 dark:border-[#007BFF]/20 dark:bg-[#007BFF]/10">
          <Package className="h-3.5 w-3.5 shrink-0 text-[#007BFF] dark:text-[#007BFF]" />
          <p className="text-[11px] font-medium text-[#007BFF] dark:text-[#007BFF]">
              ...
              <div>
                ...
                {!isCourierAssigned && (
                  <div ref={dropdownRef} className="relative mb-3">
                    ...
                    <Input
                      ...
                      className={cn(
                        inputCls,
                        "pl-9 pr-8 focus:border-[#007BFF] dark:focus:border-[#007BFF]0",
                      )}
                            ...
                            return (
                              ...
                              >
                                ...
                                {inCart ? (
                                  ...
                                  <Plus className="h-4 w-4 shrink-0 text-[#007BFF]0 opacity-0 group-hover:opacity-100 transition-opacity" />
                                )}
                              </button>
                            );
                          })
                ...
                {cartProducts.length === 0 ? (
                  ...
                  <div className="space-y-2">
                    ...
                    {/* Summary row */}
                    <div className="flex items-center justify-between rounded-xl border border-amber-200/60 bg-[#007BFF]/40 px-4 py-2.5 dark:border-[#007BFF] dark:bg-[#007BFF]/10">
