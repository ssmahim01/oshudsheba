...
const handleSelectPage = useCallback(
  ...
  return (
    <Card className="border border-amber-200/20 dark:border-[#007BFF]/20">
      ...
      <CardContent className="space-y-4">
        ...
        <input
          ...
          disabled={disabled}
          className="w-full px-3 py-2 border border-gray-200 dark:border-gray-700 rounded-lg bg-white dark:bg-slate-950 text-foreground placeholder-muted-foreground focus:outline-none focus:ring-2 focus:ring-[#007BFF]0 focus:border-transparent disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
        />
        ...
        <div className="flex items-center gap-2 p-3 border border-amber-200/20 dark:border-[#007BFF]/20 rounded-lg bg-[#007BFF]/30 dark:bg-amber-950/20">
          ...
          <Label
            htmlFor="select-all"
            className="flex-1 cursor-pointer font-semibold text-[#007BFF] dark:text-[#007BFF]"
          >
          ...
          {filteredPages.map((page) => {
            ...
            return (
              ...
              >
                ...
                {isSelected && <Check className="h-4 w-4 text-[#007BFF]" />}
              </div>
            );
          })}
        </div>
