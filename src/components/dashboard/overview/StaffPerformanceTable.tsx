...
const ROLE_BADGE: Record<string, string> = {
  ...
  TELESALES:
    "border-amber-200 bg-[#007BFF] text-[#007BFF] dark:border-amber-800 dark:bg-[#007BFF]/20 dark:text-[#007BFF]",
};
      ...
      <div className="border-b border-gray-100 px-5 py-4 dark:border-gray-800 flex items-start justify-between gap-3">
        ...
        <div className="flex items-center gap-3 shrink-0 text-right">
          ...
          <div>
            ...
            <p className="text-xs font-bold tabular-nums text-[#007BFF] dark:text-[#007BFF]">
        ...
        <Table>
          <TableHeader>
            <TableRow className="bg-[#1258a3] hover:bg-[#007BFF] dark:bg-[#007BFF]/5 dark:hover:bg-[#007BFF]/5 border-b border-[#007BFF]/80 dark:border-[#007BFF]/20">
              ...
              <TableHead
                className="text-[10px] font-bold uppercase tracking-widest text-[#cbd6e1] dark:text-[#d6e0eb] cursor-pointer select-none min-w-40"
              ...
              <TableHead
                className="text-[10px] font-bold uppercase tracking-widest text-[#cbd6e1] dark:text-[#d6e0eb] cursor-pointer select-none text-center"
                onClick={() => handleSort("totalOrders")}
              >
                Orders
                <SortIcon active={sortKey === "totalOrders"} dir={sortDir} />
              </TableHead>
              <TableHead className="text-[10px] font-bold uppercase tracking-widest text-[#cbd6e1] dark:text-[#d6e0eb] text-center">
                Status Breakdown
              </TableHead>
              <TableHead
                className="text-[10px] font-bold uppercase tracking-widest text-[#cbd6e1] dark:text-[#d6e0eb] cursor-pointer select-none text-right"
              ...
              <TableHead
                className="text-[10px] font-bold uppercase tracking-widest text-[#cbd6e1] dark:text-[#d6e0eb] text-right pr-5 cursor-pointer select-none"
            ...
            {sorted.map((staff, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <TableCell>
                    <div className="flex items-center justify-center gap-3">
                      <MiniStat
                        ...
                        cls="text-[#007BFF] dark:text-[#007BFF]"
                      />
                      <MiniStat
                        label="Confirmed"
                  ...
                  <TableCell className="text-right pr-5 font-bold tabular-nums text-[#007BFF] dark:text-[#007BFF]">
