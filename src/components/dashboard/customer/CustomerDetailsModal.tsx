                ...
                <Card className="border-gray-200 dark:border-gray-700 bg-white dark:bg-slate-800/50">
                  <CardContent className="p-4">
                    <div className="space-y-2">
                      {user.customOrderIds.map((orderId: string) => (
                        <div
                          key={orderId}
                          className="flex items-center justify-between p-2 rounded-lg bg-gray-50 dark:bg-gray-900/30 border border-gray-100 dark:border-gray-800 hover:bg-gray-100 dark:hover:bg-gray-900/50 transition-colors"
                        >
